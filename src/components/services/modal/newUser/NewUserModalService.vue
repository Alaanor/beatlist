...
import NewUserModalSetInstallationPath
  from '@/components/services/modal/newUser/NewUserModalSetInstallationPath.vue';
import NewUserModalScanContent
  from '@/components/services/modal/newUser/NewUserModalScanContent.vue';
